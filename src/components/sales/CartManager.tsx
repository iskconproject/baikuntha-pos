    ...
    return (
      <div className={`bg-white rounded-lg shadow-sm border border-gray-200 ${className}`}>
        <div className="p-6 text-center">
          ...
          <p className="text-gray-600">Add products to start a transaction</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={`bg-white rounded-lg shadow-sm border border-gray-200 ${className}`}>
      ...
      <div className="max-h-96 overflow-y-auto">
        {items.map((item) => (
          <div key={`${item.productId}-${item.variantId || 'base'}`} className="p-4 border-b border-gray-100 last:border-b-0">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
      ...
      <div className="p-4 border-t border-gray-200 bg-gray-50">
        ...
        {onCheckout && (
          <button
            onClick={onCheckout}
            className="w-full mt-4 px-4 py-3 bg-orange-600 text-white rounded-md hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 font-medium"
          >
            Proceed to Checkout
          </button>
        )}
