      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        {transactions.length > 0 ? (
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-4 mt-1">
                            <p className="text-sm text-gray-500">
                              {formatDateTime(transaction.createdAt).date} at {formatDateTime(transaction.createdAt).time}
                            </p>
                            <p className="text-sm text-gray-500">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-3 gap-4 text-sm">
                        <div>
                          ...
                          <p className="font-medium">{formatCurrency(transaction.subtotal)}</p>
                        </div>
                        <div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {transaction.items.map((item, index) => (
                            <div key={item.id || index} className="flex justify-between items-center text-sm bg-white rounded p-2">
                              <div>
                      ...
                      <div className="flex space-x-2 pt-2 border-t border-gray-200">
                        ...
                        <button
                          onClick={() => {
                            ...
                            console.log('Reprint receipt for transaction:', transaction.id);
                          }}
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-600">
              No transactions match your current filters. Try adjusting the date range or payment method.
            </p>
          </div>
        )}
      </div>
