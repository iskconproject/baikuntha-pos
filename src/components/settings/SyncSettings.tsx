  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <FormField
          label="Sync Mode"
          hint="How data synchronization should be handled"
        >
          <Select
        ...
        <FormField
          label="Sync Interval"
          hint="How often automatic sync should occur"
        >
          <Select
        ...
        <FormField
          label="Auto Retry"
          hint="Automatically retry failed sync operations"
        >
        ...
        <FormField
          ...
          hint="How to handle data conflicts during sync"
        >
          <Select
