...
export function BackupRestore({ settings, onChange }: BackupRestoreProps) {
  ...
  const handleCreateBackup = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `vaikunthapos-backup-${new Date().toISOString().split('T')[0]}.json`;
    ...
    <div className="space-y-6">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <FormField
            ...
            description="Include product images in backups"
          >
            <label className="flex items-center space-x-2">
              <input
                type="checkbox"
          ...
          <FormField
            label="Compression"
            description="Compress backups to reduce file size"
          >
            <label className="flex items-center space-x-2">
              <input
                type="checkbox"
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormField
            label="Create Backup"
            description="Download a complete backup of your data"
          >
            <Button
          ...
          <FormField
            ...
            description="Upload and restore from a backup file"
          >
            <input
              type="file"
              accept=".json"
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <FormField
            label="Storage Usage"
            description="Current local storage usage"
          >
