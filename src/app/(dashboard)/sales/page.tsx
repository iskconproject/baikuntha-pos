...
export default function SalesPage() {
  ...
  const [enhancedTransaction, setEnhancedTransaction] =
    useState<EnhancedTransaction | null>(null);
  ...
  const enhanceTransactionWithProductDetails = async (
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <p className="font-mono text-gray-900">
                          {enhancedTransaction.id}
                        </p>
                      </div>
                      <div>
                        <span className="text-gray-600">Date & Time:</span>
                        <p className="text-gray-900">
                          {formatDate(enhancedTransaction.createdAt)}
                        </p>
                      </div>
                      <div>
                        <span className="text-gray-600">Payment Method:</span>
                        <p className="text-gray-900 capitalize">
                          {enhancedTransaction.paymentMethod}
                        </p>
                      </div>
                      <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {formatCurrency(enhancedTransaction.subtotal)}
                        </span>
                      </div>
                      {enhancedTransaction.tax > 0 && (
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium">
                            {formatCurrency(enhancedTransaction.tax)}
                          </span>
                        </div>
                      )}
                      {enhancedTransaction.discount > 0 && (
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium text-green-600">
                            -{formatCurrency(enhancedTransaction.discount)}
                          </span>
                        </div>
                      )}
