...
async function copyData() {
  ...
  try {
    ...
    const users = await prodClient.execute(
    ...
    const categories = await prodClient.execute(
    ...
    const products = await prodClient.execute(
    ...
    const variants = await prodClient.execute(
      "SELECT * FROM product_variants ORDER BY created_at"
    );
